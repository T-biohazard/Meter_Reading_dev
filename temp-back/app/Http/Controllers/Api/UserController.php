...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'first_name' => 'required|string|max:255', // Added validation for new field
            'last_name' => 'required|string|max:255',  // Added validation for new field
        ...
        $user = User::create([
            'name' => $request->name, // Store name as is, assuming it's already formatted
